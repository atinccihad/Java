...
public class C02_overloading {
    public static void main(String[] args) {
        ...
        Mesela String'in bir bolumunu almak icin Java
        ...
        degistirebilecegimiz seyler
         ...
         3- ayni sayida ve ayni data turunde parametreleri olan methodlarda parametrelerin siralanisi, degistirilebilir
         */
    }
}
