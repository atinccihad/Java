...
public class C05_length {
    public static void main(String[] args) {
        ...
        System.out.println(str.charAt(str.length() - 1)); // str in son karakteri p
        System.out.println(str.charAt(str.length() - 3)); // str in sondan 3. karakteri k
        ...
        System.out.println(str3.length()); // bir deger atanmamis ki nasil uzunlugu olsun der=> NullPointerException
