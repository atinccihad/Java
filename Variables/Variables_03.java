...
public class C03_Variables {
	...
	public static void main(String[] args) {
       ...
       System.out.println(sayi3+sayi4); //1020 yanyana ekler tırnak içinde oldukları için işlem olarak yapmaz
       ...
       //char ekstra ozelliigi sabebiyle matemariksel islemlerde numerik deger alır
